...
//	}
    ...
    private void initView(Context context) {
        mContext = context;
        initIndicatorGroupButton( mContext.getResources().getDisplayMetrics().widthPixels * 7 / 24
     ...
     * @param width
     */
    public void initIndicatorBottom(int width) {
        radioGroupButtonWidth = width;
        radioGroupButtonHeight = RadioGroup.LayoutParams.MATCH_PARENT;
        android.view.ViewGroup.LayoutParams indicator_LayoutParams = iv_indicator
                .getLayoutParams();
        indicator_LayoutParams.width = radioGroupButtonWidth;
        iv_indicator.setLayoutParams(indicator_LayoutParams);
